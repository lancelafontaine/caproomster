...
def test_valid_make_new_reservation_timeslots_with_reservations():
	with app.app_context():
		with app.test_request_context():
			...
			user = User('mr', 'pickles')
			reservation1 = Reservation(room, user, time, 'description', Equipment("equipmentID_Uviv"), "ReservationID_rtycvuvib")
...
def test_valid_make_new_reservation_timeslots_with_reservations_lower_bound():
	with app.app_context():
		with app.test_request_context():
			...
			user = User('mr', 'pickles')
			reservation1 = Reservation(room, user, time, 'description', Equipment("equipmentID_trxcyv"), "reservationID_txcfyvuyb")
...
def test_valid_make_new_reservation_timeslots_with_reservations_upper_bound():
	with app.app_context():
		with app.test_request_context():
			...
			room = Room(1)
			user = User('mr', 'pickles')
			reservation1 = Reservation(room, user, timeslot, 'description', Equipment("equipmentID_jkljh"), "reservationID_dsxfgc")
			reservations.append(reservation1)
...
def test_invalid_make_new_reservation_timeslots_overlapping_time_1():
	with app.app_context():
		with app.test_request_context():
			...
			user = User('mr', 'pickles')
			reservation1 = Reservation(room, user, time, 'description', Equipment("equipmentID_fdxgch"), "reservationID_fdjhbk")
			reservations.append(reservation1)
...
def test_invalid_make_new_reservation_timeslots_overlapping_time_2():
	with app.app_context():
		with app.test_request_context():
			...
			room = Room(1)
			user = User('mr', 'pickles')
			reservation1 = Reservation(room, user, time, 'description', Equipment("equipmentID_cghvjb"), "reservationID_ghvjbas")
			reservations.append(reservation1)
...
def test_invalid_make_new_reservation_timeslots_overlapping_time_4():
	with app.app_context():
		with app.test_request_context():
			...
			reservation1 = Reservation(room, user, time, 'description', Equipment("equipmentID_ghvjbk"), "reservationID_hvjbka")
			reservations.append(reservation1)
	...
	with app.app_context():
		with app.test_request_context():
			...
			def reservation_create(*args, **kwargs):
				...
				return Reservation(room, user, time, 'description', Equipment("equipmentID_yvhjb"),"reservationID_vghjbk")
	...
	with app.app_context():
		with app.test_request_context():
			def find_by_room(*args, **kwargs):
				...
				return [Reservation(room, user, time, 'description', Equipment("equipmentID_vguhbikjn"), "reservationID_tcytvuhb")]
	...
	with app.app_context():
		with app.test_request_context():
			def find_by_user(*args, **kwargs):
				...
				return [Reservation(room, user, time, 'description', Equipment("equipmentID_hgcvjb"), "reservationID_vuhbiuj")]
	...
	with app.app_context():
		with app.test_request_context():
			def find_by_room(*args, **kwargs):
				...
				return [Reservation(room, user, time, 'description', Equipment("equipmentID_uyvbin"), "reservationID_ygvuhjbk")]
