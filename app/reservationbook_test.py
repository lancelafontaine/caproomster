...
#
#     # execute
#     reservationbook.make_new_reservation(room, user1, timeslot1, description, equipment1)
#
...
def test_valid_get_all_rooms(monkeypatch):
    def rooms_found():
    ...
    response = reservationbook.get_all_rooms()
